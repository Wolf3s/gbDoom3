...
static void SetSDLIcon()
{
	...
	#include "doom_icon.h" // contains the struct doom3_icon

	SDL_Surface* icon = SDL_CreateRGBSurfaceFrom((void*)doom3_icon.pixel_data, doom3_icon.width, doom3_icon.height, doom3_icon.bytes_per_pixel*8, doom3_icon.bytes_per_pixel*doom3_icon.width, rmask, gmask, bmask, amask);
...
#if ! SDL_VERSION_ATLEAST(2, 0, 0)
	#error "sprinkled-dewm3 only supports the tools with SDL2, not SDL1!"
#endif
