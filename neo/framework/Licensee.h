...
#if defined(__AROS__)
#define GAME_NAME						"gbDoom3"		// appears on window titles and errors
#define CONFIG_FILE						"DoomConfig.cfg"
#else
#define GAME_NAME						"gbDoom3"		// appears on window titles and errors
#endif

#define ENGINE_VERSION					"gbDoom3 1.0.0"	// printed in console
...
// win32 info
#define WIN32_CONSOLE_CLASS				"gbDoom3 WinConsole"
